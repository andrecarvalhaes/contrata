...
export default function GoogleButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={disabled}
      className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-200 rounded-xl bg-white hover:bg-gray-50 transition-colors duration-150 text-sm font-medium text-[#1A1A2E] disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
    >
      {/* Google SVG Icon */}
      <svg
        width="18"
